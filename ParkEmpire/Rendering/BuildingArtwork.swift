...
enum BuildingArtwork {
    ...
    private static func key(for appearance: BuildingAppearance,
        ...
        "\(prefix)-\(appearance.motif.rawValue)-\(appearance.primary.rawValue)"
            ...
            + "-v\(appearance.variant)-\(Int(size.width))x\(Int(size.height))"
    }
    ...
    private static func drawBody(_ appearance: BuildingAppearance,
        ...
        let variant = appearance.variant
        ...
        case .tree:      drawTree(context, size, primary, secondary, accent, variant)
        case .conifer:   drawConifer(context, size, primary, secondary, accent, variant)
        case .flowerBed: drawFlowerBed(context, size, primary, secondary, accent, variant)
        case .fountain:  drawFountainBasin(context, size, primary, secondary, accent, variant)
        ...
        case .gardenArch: drawGardenArch(context, size, primary, secondary, accent, variant)
        case .clockTower: drawClockTower(context, size, primary, secondary, accent, variant)
        }
    }
